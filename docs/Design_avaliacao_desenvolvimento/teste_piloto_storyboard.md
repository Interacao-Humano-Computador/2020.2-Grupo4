# Teste Piloto da Avaliação do Storyboard
...
<p align = "justify">O avaliador Luis Marques ira realizar a avaliação dos storyboards seguindo o planejamento previamente realizado.</p>
...
<p align = "justify">Após o questionário aplicado,o avaliador considerou que estas estão simples e sucintas e que os participantes irão se sentir  confortáveis em responder o questionário.Alem disso a forma que a avaliação irá ocorrer está optimizada para a realização deste tipo de avaliação. </p>
