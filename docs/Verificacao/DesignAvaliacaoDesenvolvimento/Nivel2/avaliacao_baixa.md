# Verificação Avaliação do Protótipo de Baixa-Fidelidade
...
| 07/05/2021 | 0.5    | Adição de acompanhamento                      | Giovana Dionisio | Hérya Rodrigues  |

## Contexto 
<p align="justify"> Este documento trata de uma verificação sobre o artefato <a href = "https://interacao-humano-computador.github.io/2020.2-cil2bsb/Design_avaliacao_desenvolvimento/avaliacao_baixa_fidelidade/">Avaliação do Protótipo de Baixa-Fidelidade.</a></p>
...
### Técnica
1. A avaliação ocorreu de acordo com o planejamento?
* Está explícito quais foram os avaliadores e quais foram os participantes?
* Está explícito como os resultados foram coletados?
* Os resultados da avaliação foram relatados?
...
## Conclusão
<p align="justify"> Através da verificação por checklist foi possível identificar que a ortografia do título não está correta, que o documento não possui uma explicação sobre o assunto que está sendo abordado e que não está claro quais foram os avaliadores desta avaliação. </p>
